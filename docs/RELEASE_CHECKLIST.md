...
- Confirm export audio sync remains within 50 ms after one hour.
...
- Configure private S3, lifecycle deletion, CDN, Redis persistence, Resend domain, and AI job safeguards.
- Run authorization, upload interruption, expired link, password brute force, data export, and account deletion suites.
